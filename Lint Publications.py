...
def check_pdf_creator(html_info, html_text, pdf_info, pdf_text):
    if pdf_info['PDF CREATOR'] not in ['LaTeX with acmart 2021/05/01 v1.78 Typesetting articles for the Association for Computing Machinery and hyperref 2018/02/06 v6.86b Hypertext links for LaTeX']:
        return "This PDF has not been generated by TAPS ('Producer' field in metadata says so)"
